...
export const companiesData: ExosomeCompany[] = [
  {
    ...
    leadership_team: [
      ...
      },
      {
        ...
        title: "Former FDA CBER Official & LSU Leadership",
        background: "Former FDA Center for Biologics Evaluation and Research (CBER) official. Current Professor & Department Head, Department of Genetics, LSU Health School of Medicine. Director for Inter-Institutional Programs, LSU Stanley Scott Cancer Center. Assistant Dean for Translational Science. Published researcher in cancer biology and translational science. Expert in regulatory pathways for biologics and regenerative medicine products.",
        regulatory_history: "Former FDA CBER regulatory authority with direct expertise in drug classification, IND approval, and biologics compliance. Brings FDA regulatory perspective to DynaCord's compliance strategy.",
        pedigree_level: "High",
      },
    ],
