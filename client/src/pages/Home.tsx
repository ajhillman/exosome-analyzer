...
export default function Home() {
  ...
  return (
    <div style={{ background: P.bg, minHeight: "100vh", fontFamily: "'Inter','Helvetica Neue',sans-serif", color: P.text }}>
      ...
      {activeTab === "studies" && <div style={{ position: "relative" }}><div style={{ position: "absolute", inset: 0, backgroundImage: "url(https://d2xsxph8kpxj0f.cloudfront.net/310519663126495647/FDJ5hrYjuWWT9pWZoFgQus/exosome-bg-studies-iDAx3mcCAupAbgjQDeKJyh.webp)", backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed", opacity: 0.15, pointerEvents: "none" }} /><div style={{ position: "relative", maxWidth: "1400px", margin: "0 auto", padding: "80px 24px 40px" }}><StudiesSection /></div></div>}
      ...
      {activeTab === "statechecklist" && <div style={{ position: "relative" }}><div style={{ position: "absolute", inset: 0, backgroundImage: "url(https://d2xsxph8kpxj0f.cloudfront.net/310519663126495647/FDJ5hrYjuWWT9pWZoFgQus/exosome-bg-studies-iDAx3mcCAupAbgjQDeKJyh.webp)", backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed", opacity: 0.08, pointerEvents: "none" }} /><div style={{ position: "relative", maxWidth: "1400px", margin: "0 auto", padding: "80px 24px 40px" }}><StateChecklist /></div></div>}
      {activeTab === "dmf" && <div style={{ position: "relative" }}><div style={{ position: "absolute", inset: 0, backgroundImage: "url(https://d2xsxph8kpxj0f.cloudfront.net/310519663126495647/FDJ5hrYjuWWT9pWZoFgQus/exosome-bg-reportcard-N8zygDvNcAMFVGRtWDNRDo.webp)", backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed", opacity: 0.08, pointerEvents: "none" }} /><div style={{ position: "relative", maxWidth: "1400px", margin: "0 auto", padding: "80px 24px 40px" }}><DMFEducation /></div></div>}
      {activeTab === "compliance" && <div style={{ position: "relative" }}><div style={{ position: "absolute", inset: 0, backgroundImage: "url(https://d2xsxph8kpxj0f.cloudfront.net/310519663126495647/FDJ5hrYjuWWT9pWZoFgQus/exosome-bg-regulatory-FrJ5zwREB3X4fdMRHi73cK.webp)", backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed", opacity: 0.1, pointerEvents: "none" }} /><div style={{ position: "relative", maxWidth: "1400px", margin: "0 auto", padding: "80px 24px 40px" }}><ComplianceCase /></div></div>}
